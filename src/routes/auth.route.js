...
const {
  authValidation: { validateRegister, validateLogin, validateRefreshTokens, validateForgotPassword, validateResetPassword },
} = require('../validations');
const {
  authController: { register, login, logout, forgotPassword, resetPassword },
} = require('../controllers');
